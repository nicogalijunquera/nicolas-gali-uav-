%% 3D Mesh Independence Study – Model 3: AR=10 + Winglet
...
elements = [4315574,   9178811,  15641221, 21906472];
drag     = [8.2698955, 7.4867364, 7.1700474, 7.1048];
lift     = [156.595,   152.790,   150.437,   149.730];
x        = 1:numel(meshID);
...
fig = figure('Color','w','Units','centimeters','Position',[2 2 30 22], ...
             'Name','3D Mesh Independence Study — Model 3');
tl = tiledlayout(2,2,'TileSpacing','compact','Padding','compact');
title(tl,'3D Mesh Independence Study — Model 3', ...
    'FontSize',22,'FontWeight','bold','FontName',fnt);
subtitle(tl,'AR = 10 + Winglet  |  RANS CFD  |  Successive mesh refinement', ...
...
%% ── Export ───────────────────────────────────────────────────────────────
exportgraphics(fig,'mesh_independence_model3.png','Resolution',300);
exportgraphics(fig,'mesh_independence_model3.pdf','ContentType','vector');
fprintf('Saved mesh_independence_model3.png and .pdf\n');