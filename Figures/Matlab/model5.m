%% 3D Mesh Independence Study – Model 5: AR=10 + Optimised Aerofoil + Winglet
...
elements = [4688701,   9828240,  16906377, 22541836];
drag     = [8.7454455, 7.4537432, 7.0460234, 6.9812];
lift     = [159.716,   155.212,   152.076,   151.240];
x        = 1:numel(meshID);
...
fprintf('==============================================\n');
fprintf('  Model 5 — AR=10 + Optimised Aerofoil + Winglet\n');
fprintf('==============================================\n');
...
fig = figure('Color','w','Units','centimeters','Position',[2 2 30 22], ...
             'Name','3D Mesh Independence Study — Model 5');
tl = tiledlayout(2,2,'TileSpacing','compact','Padding','compact');
title(tl,'3D Mesh Independence Study — Model 5', ...
    'FontSize',22,'FontWeight','bold','FontName',fnt);
subtitle(tl,'AR = 10 + Optimised Aerofoil + Winglet  |  RANS CFD  |  Successive mesh refinement', ...
...
exportgraphics(fig,'mesh_independence_model5.png','Resolution',300);
exportgraphics(fig,'mesh_independence_model5.pdf','ContentType','vector');
fprintf('Saved mesh_independence_model5.png and .pdf\n');